...
section.main,[class*="css"]{background-color:#eef0f9!important;color:#1a1d2e!important;color-scheme:light!important;}
...
with st.expander("🧠  About the AI Models & How to Use", expanded=False):
    ...
    with _c3:
        ...
        <div class='info-card' style='border-top:3px solid #4f46e5;'>
            ...
            <p><b>30–80 words.</b> TF-IDF extractive — picks the most important sentences.
    ...
    for _num, _txt in [
        ...
        st.markdown(
            ...
            f'<div class="step-num">{_num}</div>'
            f'<div class="step-text">{_txt}</div>'
...
with tab_pdf:
    ...
    if uploaded:
        _pdf_bytes = uploaded.read()   # read once to avoid seek issues
        try:
